...
export function Login() {
    return(
        <main className="max-w-5xl mx-auto h-screen flex items-center">
            <section className="h-[60%] grid grid-cols-2 items-center my-auto gap-7 px-10 py-5 bg-white">
                <section className="flex flex-col h-full pl-5 gap-6">
                    ...
                    <div className="flex justify-between">
                        <div className="flex gap-2">
                            <input type="checkbox" name="" id="" className="checked:bg-primary" /><label htmlFor="">Remenber me</label>
                        </div>
                ...
                <img src="https://img.freepik.com/fotos-premium/imagen-llamativa-mujer-joven-plantas-que-dan-toque-naturaleza-su-rostro-aigenerated_796128-2753.jpg" alt="imagen login" className="size-full object-cover" />
            </section>
        </main>
    )
}